...
quantity. Measured, a target four times tighter than the working one drove $B$ to $13.3$
where $4$ sufficed and to $15.3$ where $8$ did.
...
is on interpretability rather than on counting: role coverage rises from $0.74$ to $0.81$
and converged loss falls by roughly a factor of three, at identical tracking.
